    ...
    <div>
      <div className='flex flex-col lg:flex-row items-center gap-12 mb-10'>
        ...
        <div className=' h-fit  relative shadow-blue-200  shadow-[0px_0px_30px_0px]'>
          ...
          <div className='absolute flex flex-row opacity-0 sm:opacity-100 left-[50%] bottom-0 text-white -translate-x-[50%] translate-y-10 uppercase  gap-0 bg-caribbeangreen-700  py-6'>
